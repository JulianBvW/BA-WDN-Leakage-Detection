...
Damit die Daten weiterhin als Zeitfolgen betrachtet werden können, gleichzeitig aber auf mehreren Szenarien
 ...
 $\mathbb{R}^{N \times p \times d}$, mit $p$ als Datenpunkte pro Zeitfolge und $N$ als Anzahl
 Zeitfolgen\footnote{TODO p nicht constant}. Damit kann dem Modell eine Liste an Zeitfolgen übergeben werden,
